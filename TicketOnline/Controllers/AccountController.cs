    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                var resultFb = await _userManager.CreateAsync(user);
                if (resultFb.Succeeded)
                {
                    resultFb = await _userManager.AddLoginAsync(user, info);
                    if (resultFb.Succeeded)
                    {
                        ...
                        customer.Name = info.Principal.FindFirstValue(ClaimTypes.Name);
                        customer.Phone = info.Principal.FindFirstValue(ClaimTypes.MobilePhone);
